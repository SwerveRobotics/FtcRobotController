...
public class CompetitionSpecimenAuto extends BaseOpMode {
    ...
    public void runOpMode() {
        ...
        Action trajectoryAction = drive.actionBuilder(beginPose)
                ...
                .afterDisp(0,new MoveArm(ARM_COLLECT,WRIST_FOLDED_OUT))
                .splineToLinearHeading(new Pose2d((ROBOT_LENGTH / -2) -24, 72 -(ROBOT_WIDTH / 2),Math.toRadians(180)), Math.toRadians(180))
                ...
                .setTangent(Math.toRadians(90))
                .splineToLinearHeading(new Pose2d((ROBOT_LENGTH / -2)+6, Y_SCORE_POSE+6, Math.toRadians(-90)), Math.toRadians(90),new TranslationalVelConstraint(20))
                .stopAndAdd(new ScoreSample())
                .setTangent(Math.toRadians(180))
