...
public final class XDrive {
    ...
    public final XKinematics kinematics = new XKinematics(
    ...
    public class DriveLocalizer implements Localizer {
        ...
        public DriveLocalizer() {
            leftFront = new OverflowEncoder(new RawEncoder(XDrive.this.leftFront));
            leftBack = new OverflowEncoder(new RawEncoder(XDrive.this.leftBack));
            rightBack = new OverflowEncoder(new RawEncoder(XDrive.this.rightBack));
            rightFront = new OverflowEncoder(new RawEncoder(XDrive.this.rightFront));
        ...
        public Twist2dDual<Time> update() {
            ...
            Twist2dDual<Time> twist = kinematics.forward(new XKinematics.WheelIncrements<>(
    ...
    public XDrive(HardwareMap hardwareMap, Pose2d pose) {
        this.pose = pose;
    ...
    public void setDrivePowers(PoseVelocity2d powers) {
        ...
        XKinematics.WheelVelocities<Time> wheelVels = new XKinematics(1).inverse(
            ...
            PoseVelocity2d assistVelocity)
    {
        ...
        XKinematics.WheelVelocities<Time> manualVels = new XKinematics(1).inverse(
        ...
        XKinematics.WheelVelocities<Time> assistVels = kinematics.inverse(command);
    ...
    public final class FollowTrajectoryAction implements Action {
        ...
        public boolean run(@NonNull TelemetryPacket p) {
            ...
            XKinematics.WheelVelocities<Time> wheelVels = kinematics.inverse(command);
            double voltage = voltageSensor.getVoltage();
