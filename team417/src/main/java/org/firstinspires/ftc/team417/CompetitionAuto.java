...
//                            .setTangent(Math.toRadians(180))
                    ...
                    for (int i = 2; i < intakeCycles; i++) {
                        trajectoryAction = trajectoryAction.setTangent(Math.toRadians(45))
                                ...
                                .splineToSplineHeading(new Pose2d(12, 58, Math.toRadians(130)), Math.toRadians(90)) //go to intake middle from goal
                                .setTangent(Math.toRadians(-90))
                                .splineToConstantHeading(new Vector2d(20, 58), Math.toRadians(60))
