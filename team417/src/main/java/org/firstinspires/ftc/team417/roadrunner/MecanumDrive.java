        ...
        Params() {
            ...
            switch (driveParameters) {
                case DEVBOT_MECANUM:
                    ...
                    inPerTick = 1.0;
                    lateralInPerTick = 0.860; // Was 1.00
                    trackWidthTicks = 14.89; // Was 0.00

                    kS = 0.658; // Was 0
                    kV = 0.197; // Was 0
                    kA = 0.0120; // was 0

                    axialGain = 8.00; // Was 0
                    axialVelGain = 1.10; // Was 0
                    lateralGain = 2.01; // Was 0.00
                    lateralVelGain = 0.00; // Was 0.00
                    headingGain = 5.00; // Was 0.0
                    headingVelGain = 0;

                    otos.offset.x = 6.337; // Was 0.00
                    otos.offset.y = 2.924; // Was 0.00
        ...
        switch (driveParameters) {
            case DEVBOT_MECANUM:
                ...
                if (BaseOpModeFastBot.USE_DISTANCE) {
                    ...
                    DistanceSensorInfo rightInfo = new DistanceSensorInfo(6.34375, 0, Math.PI / 2);
