package org.firstinspires.ftc.team417.javaclasses;
...
public class MecanumDrive extends LinearOpMode {
    ...
    public final double MECANUM_DRIVE_CONSTANT = 1.1;

    @Override
    public void runOpMode() {
        bl = initializeMotor("leftBack", DcMotor.Direction.FORWARD);
        br = initializeMotor("rightBack", DcMotor.Direction.REVERSE);
        fl = initializeMotor("leftFront", DcMotor.Direction.FORWARD);
        fr = initializeMotor("rightFront", DcMotor.Direction.REVERSE);
    ...
    public void driveRobot() {
        ...
        double x = gamepad1.left_stick_x * MECANUM_DRIVE_CONSTANT;
