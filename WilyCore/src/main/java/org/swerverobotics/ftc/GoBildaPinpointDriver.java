...
public class GoBildaPinpointDriver extends I2cDeviceSynchDevice<I2cDeviceSynchSimple> {
    ...
    public Pose2D getPosition(){
        Pose2d pose = WilyCore.getPose(false);  // Use error-added pose
    ...
    public Pose2D getVelocity(){
        PoseVelocity2d poseVelocity = WilyCore.getPoseVelocity();
        return new Pose2D(DistanceUnit.INCH,
                poseVelocity.linearVel.x,
                poseVelocity.linearVel.y,
                AngleUnit.RADIANS,
                poseVelocity.angVel);
    }
}
