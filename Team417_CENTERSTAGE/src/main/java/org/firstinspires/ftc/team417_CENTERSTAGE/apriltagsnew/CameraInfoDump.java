...
public class CameraInfoDump {
    ...
    public static CameraInfo[] cameraInfoArray = new CameraInfo[] {
            ...
            new CameraInfo("DevBotFastCamera", "webcamback", new Vector2d(5.5, -7), 180, new Size(1280, 800), new LensIntrinsics(906.940247073, 906.940247073, 670.833056673, 355.34234068), 190, Math.toRadians(70.4))
    };
