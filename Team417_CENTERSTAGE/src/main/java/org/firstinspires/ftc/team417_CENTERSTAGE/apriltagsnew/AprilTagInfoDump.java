...
public class AprilTagInfoDump {
    ...
    public static final AprilTagInfo[] AprilTagInfoArray = new AprilTagInfo[] {
            ...
            new AprilTagInfo(1, library.lookupTag(1).tagsize, library.lookupTag(1).fieldPosition.getData()[0], library.lookupTag(1).fieldPosition.getData()[1], library.lookupTag(1).fieldPosition.getData()[2], 180),
            new AprilTagInfo(2, library.lookupTag(2).tagsize, library.lookupTag(2).fieldPosition.getData()[0], library.lookupTag(2).fieldPosition.getData()[1], library.lookupTag(2).fieldPosition.getData()[2], 180),
            new AprilTagInfo(3, library.lookupTag(3).tagsize, library.lookupTag(3).fieldPosition.getData()[0], library.lookupTag(3).fieldPosition.getData()[1], library.lookupTag(3).fieldPosition.getData()[2], 180),
            new AprilTagInfo(4, library.lookupTag(4).tagsize, library.lookupTag(4).fieldPosition.getData()[0], library.lookupTag(4).fieldPosition.getData()[1], library.lookupTag(4).fieldPosition.getData()[2], 180),
            new AprilTagInfo(5, library.lookupTag(5).tagsize, library.lookupTag(5).fieldPosition.getData()[0], library.lookupTag(5).fieldPosition.getData()[1], library.lookupTag(5).fieldPosition.getData()[2], 180),
            new AprilTagInfo(6, library.lookupTag(6).tagsize, library.lookupTag(6).fieldPosition.getData()[0], library.lookupTag(6).fieldPosition.getData()[1], library.lookupTag(6).fieldPosition.getData()[2], 180),
