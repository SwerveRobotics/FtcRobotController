    ...
    public static class Params {
        Params() {
            ...
            if (isDevBot) {
                ...
                inPerTick = 1;
                lateralInPerTick = 0.805;
                trackWidthTicks = 16.31;
                ...
                otos.angularScalar = 1.0036;

                pinpoint.ticksPerMm = 71.653;
                pinpoint.xReversed = false;
                pinpoint.yReversed = true;
                pinpoint.xOffset = 200.6;
                pinpoint.yOffset = 117.8;
            } else {
