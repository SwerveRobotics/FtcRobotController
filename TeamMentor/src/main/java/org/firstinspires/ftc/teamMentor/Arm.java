...
//    static final double SEGMENT_WIDTH = 0.00001;
    ...
    static final double Y_BOUNDS = 4; // Bounds of the arm in the positive Y direction
    static final double X_CLAW_BOUNDS = 2; // Additional X bounds to account for the claw
    static final double SUBMERSIBLE_HEIGHT = 4; // Distance from claw tip to floor when in submersible
}
