...
import org.firstinspires.ftc.teamMentor.roadrunner.TankDrive;
import org.firstinspires.ftc.teamMentor.roadrunner.ThreeDeadWheelLocalizer;
import org.firstinspires.ftc.teamMentor.roadrunner.TwoDeadWheelLocalizer;
...
public final class TuningOpModes {
    ...
    public static void register(OpModeManager manager) {
        ...
        if (DRIVE_CLASS.equals(MecanumDrive.class)) {
            dvf = hardwareMap -> {
                MecanumDrive md = new MecanumDrive(hardwareMap, null, null, new Pose2d(0, 0, 0));
