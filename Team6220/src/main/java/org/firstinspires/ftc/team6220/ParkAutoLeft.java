 ...
 */
@Autonomous(name="ParkAutoLeft", group="Competition", preselectTeleOp="CompetitionTeleOp")
public class ParkAutoLeft extends BaseOpMode {
    ...
    public void runOpMode() {
        ...
        Action leftParkingTrajectory = drive.actionBuilder(leftPose)
                ...
                .build();
        Action trajectoryAction = leftParkingTrajectory;
