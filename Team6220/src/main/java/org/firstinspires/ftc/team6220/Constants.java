...
public abstract class Constants {
    ...
    public static final int ARM_BASE_MOTOR_POSITION_GROUND = 0;
    public static final int ARM_BASE_MOTOR_POSITION_FOLD = 40;
    public static final int SLIDES_MOTOR_GROUND_POSITION = 0;
    public static final int SLIDES_MOTOR_POSITION_ONE = 20;
    public static final int SLIDES_MOTOR_POSITION_TWO = 40;
